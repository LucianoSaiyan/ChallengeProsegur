...
namespace Project.Service
{
    ...
    {
        Task<ResponseService<List<CustomerDTO>>> HttpGet();
        Task<ResponseService<CustomerDTO>> HttpGetId(int id);
        Task<ResponseService<IEnumerable<CustomerDTO>>> HttpGetByCustomer(string nombre);
        Task<ResponseService<CustomerDTO>> HttpPost(CustomerDTO entityDTO);
        Task<ResponseService<CustomerDTO>> HttpPut(CustomerDTO entityDTO);
